...
if [ -d "$AVP64_LINUX_BUILD" ]
then
    echo "found avp64 linux build in $AVP64_LINUX_BUILD"
    ...
    echo "avp64 linux build not found in $AVP64_LINUX_BUILD"
fi
...
if [ -d "$AVP64_XEN_BUILD" ]
then
    echo "found avp64 xen build in $AVP64_XEN_BUILD"
    ...
    echo "avp64 xen build not found in $AVP64_XEN_BUILD"
fi
